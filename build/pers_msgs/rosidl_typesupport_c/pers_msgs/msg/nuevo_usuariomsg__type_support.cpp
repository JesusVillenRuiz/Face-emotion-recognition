...
#include "pers_msgs/msg/detail/nuevo_usuariomsg__type_support.h"
...
static const _NuevoUsuariomsg_type_support_symbol_names_t _NuevoUsuariomsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pers_msgs, msg, NuevoUsuariomsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pers_msgs, msg, NuevoUsuariomsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pers_msgs, msg, NuevoUsuariomsg)() {
  return &::pers_msgs::msg::rosidl_typesupport_c::NuevoUsuariomsg_message_type_support_handle;
}
