...
static const _NewUsermsg_type_support_symbol_names_t _NewUsermsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pers_msgs, msg, NewUsermsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pers_msgs, msg, NewUsermsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pers_msgs, msg, NewUsermsg)() {
  return &::pers_msgs::msg::rosidl_typesupport_c::NewUsermsg_message_type_support_handle;
}
