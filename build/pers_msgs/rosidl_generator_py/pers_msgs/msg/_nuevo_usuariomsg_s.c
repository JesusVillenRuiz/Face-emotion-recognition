...
bool pers_msgs__msg__nuevo_usuariomsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pers_msgs.msg._nuevo_usuariomsg.NuevoUsuariomsg", full_classname_dest, 47) == 0);
  }
  pers_msgs__msg__NuevoUsuariomsg * ros_message = _ros_message;
  {  // frame
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * pers_msgs__msg__nuevo_usuariomsg__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of NuevoUsuariomsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pers_msgs.msg._nuevo_usuariomsg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NuevoUsuariomsg");
  ...
  pers_msgs__msg__NuevoUsuariomsg * ros_message = (pers_msgs__msg__NuevoUsuariomsg *)raw_ros_message;
  {  // frame
    PyObject * field = NULL;
