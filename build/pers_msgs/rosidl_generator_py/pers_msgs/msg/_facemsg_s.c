...
bool pers_msgs__msg__facemsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pers_msgs.msg._facemsg.Facemsg", full_classname_dest, 30) == 0);
  }
  pers_msgs__msg__Facemsg * ros_message = _ros_message;
  {  // faces
    ...
    sensor_msgs__msg__Image * dest = ros_message->faces.data;
...
{
  /* NOTE(esteve): Call constructor of Facemsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pers_msgs.msg._facemsg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Facemsg");
