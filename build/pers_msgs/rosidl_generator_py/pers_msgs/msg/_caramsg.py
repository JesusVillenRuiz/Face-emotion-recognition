...
class Metaclass_Caramsg(type):
    """Metaclass of message 'Caramsg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'pers_msgs.msg.Caramsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__caramsg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__caramsg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__caramsg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__caramsg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__caramsg
...
class Caramsg(metaclass=Metaclass_Caramsg):
    """Message class 'Caramsg'."""
    ...
    _fields_and_field_types = {
        'caras': 'sequence<sensor_msgs/Image>',
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'caras' field must be a set or sequence and each value of type 'Image'"
        self._caras = value
