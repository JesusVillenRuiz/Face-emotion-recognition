...
#ifndef PERS_MSGS__MSG__DETAIL__CARAMSG__TRAITS_HPP_
#define PERS_MSGS__MSG__DETAIL__CARAMSG__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  // member: caras
  {
    if (msg.caras.size() == 0) {
      ...
      out << "caras: [";
      size_t pending_items = msg.caras.size();
      for (auto item : msg.caras) {
...
inline std::string to_yaml(const Caramsg & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const pers_msgs::msg::Caramsg & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const pers_msgs::msg::Caramsg & msg)
{
  return pers_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<pers_msgs::msg::Caramsg>()
{
  return "pers_msgs::msg::Caramsg";
}

template<>
inline const char * name<pers_msgs::msg::Caramsg>()
{
  return "pers_msgs/msg/Caramsg";
}

template<>
struct has_fixed_size<pers_msgs::msg::Caramsg>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<pers_msgs::msg::Caramsg>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<pers_msgs::msg::Caramsg>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PERS_MSGS__MSG__DETAIL__CARAMSG__TRAITS_HPP_
