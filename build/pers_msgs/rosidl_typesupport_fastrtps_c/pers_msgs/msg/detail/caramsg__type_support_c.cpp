...
#include "pers_msgs/msg/detail/caramsg__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/image__functions.h"  // caras, frame
...
using _Caramsg__ros_msg_type = pers_msgs__msg__Caramsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Caramsg__ros_msg_type * ros_message = static_cast<const _Caramsg__ros_msg_type *>(untyped_ros_message);
  // Field name: caras
  {
    ...
    auto array_ptr = ros_message->caras.data;
  ...
  void * untyped_ros_message)
{
  ...
  _Caramsg__ros_msg_type * ros_message = static_cast<_Caramsg__ros_msg_type *>(untyped_ros_message);
  // Field name: caras
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
    ...
    if (ros_message->caras.data) {
      sensor_msgs__msg__Image__Sequence__fini(&ros_message->caras);
    }
    if (!sensor_msgs__msg__Image__Sequence__init(&ros_message->caras, size)) {
      fprintf(stderr, "failed to create array for field 'caras'");
      return false;
    }
    auto array_ptr = ros_message->caras.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_pers_msgs__msg__Caramsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Caramsg__ros_msg_type * ros_message = static_cast<const _Caramsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Caramsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pers_msgs__msg__Caramsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pers_msgs
size_t max_serialized_size_pers_msgs__msg__Caramsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Caramsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pers_msgs__msg__Caramsg(
...
static message_type_support_callbacks_t __callbacks_Caramsg = {
  "pers_msgs::msg",
  "Caramsg",
...
static rosidl_message_type_support_t _Caramsg__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pers_msgs, msg, Caramsg)() {
  return &_Caramsg__type_support;
}
