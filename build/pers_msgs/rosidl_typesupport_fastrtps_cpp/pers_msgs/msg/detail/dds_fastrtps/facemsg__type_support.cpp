...
#include "pers_msgs/msg/detail/facemsg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pers_msgs::msg::Facemsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pers_msgs::msg::Facemsg & ros_message)
{
  // Member: faces
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const pers_msgs::msg::Facemsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pers_msgs::msg::Facemsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Facemsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pers_msgs::msg::Facemsg *>(
...
static size_t _Facemsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Facemsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Facemsg__callbacks = {
  "pers_msgs::msg",
  "Facemsg",
...
static rosidl_message_type_support_t _Facemsg__handle = {
...
{
  return &pers_msgs::msg::typesupport_fastrtps_cpp::_Facemsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pers_msgs, msg, Facemsg)() {
  return &pers_msgs::msg::typesupport_fastrtps_cpp::_Facemsg__handle;
}
